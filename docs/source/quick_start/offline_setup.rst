...
4.2 通过浏览器访问 DaoAI World 和 DaoAI 天眼平台
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

- 在局域网设备的浏览器中输入服务器 IP 地址，例如：
   - DaoAI World http://192.168.10.61。
   - DaoAI 天眼平台 http://192.168.10.61:38080/dashboard。
- 如果成功，您将看到 DaoAI World 登录页面 或者DaoAI 天眼平台主界面。
